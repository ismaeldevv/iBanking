      ...
      <div className="bg-background relative flex h-[768px] w-[1280px] rounded-[0.5rem]">
              ...
              <div className="bg-card flex flex-col gap-4 rounded-[0.5rem] p-4 shadow flex-1">
                ...
                <div className="flex h-full flex-col gap-3">
                  <button
                    ...
                    className="inline-flex whitespace-nowrap rounded-[0.35rem] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-background border text-secondary-foreground shadow-sm transition-all hover:scale-[0.98] hover:cursor-pointer hover:bg-secondary h-fit w-full items-center justify-start gap-4 p-4"
                  >
                    <Wallet />
                    Withdraw
                  </button>
                  ...
                  <button onClick={() => navigate(`/accounts/invoices/${activeItem.id}`)} className="inline-flex whitespace-nowrap rounded-[0.35rem] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-background border text-secondary-foreground shadow-sm transition-all hover:scale-[0.98] hover:cursor-pointer hover:bg-secondary h-fit w-full items-center justify-start gap-4 p-4">
                    <Notebook />
                    Invoices
                  </button>
                  {/* <button onClick={() => navigate(`/accounts/logs/${activeItem.id}`)} className="inline-flex whitespace-nowrap rounded-[0.35rem] text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 bg-background border text-secondary-foreground shadow-sm transition-all hover:scale-[0.98] hover:cursor-pointer hover:bg-secondary h-fit w-full items-center justify-start gap-4 p-4">
                    <Logs />
                    Logs
                  </button> */}
                </div>
        ...
        {isDepositWithdraw && (
          <DepositWithdrawModal
            type={DepositWithdrawData.type}
            label={DepositWithdrawData.label}
            balance={DepositWithdrawData.balance}
            onClick={(type, value) => handleDepositWithdraw(type, value)}
          />
        )}
        ...
        {isTransferAccount && (
          <TransferAccountModal
            ...
            label={DepositWithdrawData.label}
            balance={DepositWithdrawData.balance}
            onClickTransfer={(type, id, value) =>
              handleTransfer(type, id, value)
            }
          />
        )}
      </div>
